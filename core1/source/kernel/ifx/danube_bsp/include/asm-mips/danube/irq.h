...
#define INT_NUM_IM0_IRL5   	(INT_NUM_IRQ0 + 5)	//used by the CPU1 as the command/data interrupts from the CPU0
...
#define INT_NUM_IM4_IRL18	(INT_NUM_IM4_IRL0 + 18)	//used by the CPU0 as the command/data interrupts from the CPU1
