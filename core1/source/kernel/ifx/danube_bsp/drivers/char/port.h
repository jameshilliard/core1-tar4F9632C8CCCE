...
/* 10June2005 jssow jinsze@gmail.com Danube project */ 
...
#define DANUBE_PORT_IOCALTSEL0  _IOW( DANUBE_PORT_IOC_MAGIC,6,struct danube_port_ioctl_parm)
#define DANUBE_PORT_IOCALTSEL1  _IOW( DANUBE_PORT_IOC_MAGIC,7,struct danube_port_ioctl_parm)
#define DANUBE_PORT_IOCINPUT	_IOWR(DANUBE_PORT_IOC_MAGIC,8,struct danube_port_ioctl_parm)
#define DANUBE_PORT_IOC_MAXNR   9
